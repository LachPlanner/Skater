        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div>
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <Link href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</Link>
              </div>
            </div>
            <div class="mt-2">
          ...
          <Link href="/" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Go to SkateCraft</Link>
        </p>
        </form>
      </div>
    </div>
